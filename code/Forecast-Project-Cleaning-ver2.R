...
#------------------------------------------------
# IMPUTING THE MISSING VALUES - SETTING MISSING VALUES TO 0
#------------------------------------------------
PM10[which(is.na(PM10$Concentration.PM10)),2] <- 0
...
ggplot(PM10.week,
  ...
  labs(x = "Dates",
       y = "concentration",
       title = paste("PM10 Concentration - 01/01/2012 to 01/01/2017")) +
